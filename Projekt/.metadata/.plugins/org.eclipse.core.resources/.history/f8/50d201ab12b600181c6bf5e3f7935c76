...
public class PersonalData implements Externalizable{
	...
	private final LongProperty personalDataPESEL = new SimpleLongProperty();
	...
	//setter and getter for 'personalDataPESEL'
	public long getPESEL() {
		return personalDataPESEL.get();
	}

	public void setPESEL(long value) {
		personalDataPESEL.set(value);
	}

	public LongProperty peselProperty() {
		return personalDataPESEL;
	}
