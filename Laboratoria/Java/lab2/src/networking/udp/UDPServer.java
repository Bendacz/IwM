...
public class UDPServer{
    public static void main(String[] args) throws ClassNotFoundException {
    	...
    	String spath = new String("D:/Studia/Semestry/VIII Semestr/Informatyka w Mechatronice/Laboratoria/Java/lab2/"); //tutaj proszę umieścić swoją ścieżkę do katalogu serwera
      try {
